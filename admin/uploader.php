...
";
 ...
 if ($ckeditor){ 
print "window.opener.CKEDITOR.tools.callFunction($func_num, '".$scripturl."/$saveto_filename', '');";
...
$f_name = "sender";
$frm = "sender";
print "<input type=hidden name='func_num' value='".intval($_GET['CKEditorFuncNum'])."'> 
...
print "Max: <a target=_blank href=\"http://allomani.com/".iif($global_lang=="arabic","ar","en")."/upload_max.html\">".iif($upload_max < $post_max,convert_number_format($upload_max,2,true),convert_number_format($post_max,2,ture))." </a>";
}
print "</fieldset>
